from typedb.client import TypeDB, SessionType, TransactionType, TypeDBOptions, TypeDBCredential, TypeDBClusterOptions
from datetime import datetime

print("CLUSTER — IAM Test all types of queries and their response")

credentials = TypeDBCredential("admin", "password",
                               "/Users/vladimir/tests/cluster/2.16.1/server/conf/encryption/ext-root-ca.pem")
